...
function ProfilePhoto() {
  return (
    ...
    >
      ...
      {/* Photo circle — clickable to MINDS LinkedIn */}
      <a
        href={MINDS_LINKEDIN_URL}
        target="_blank"
        rel="noopener noreferrer"
        className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-2 border-[#085a64]/60 shadow-[0_0_40px_rgba(8,90,100,0.3)] hover:border-[#a4d3df]/60 hover:shadow-[0_0_50px_rgba(8,90,100,0.5)] transition-all duration-300"
...
export function HeroAwards() {
  return (
    <div className="pt-8 border-t border-border/50 flex flex-wrap gap-x-6 gap-y-4 font-mono text-sm text-muted-foreground/80 items-center justify-center lg:justify-start">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16 max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-[7vw] sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-foreground mb-4 whitespace-nowrap"
            >
            ...
            <motion.div
              variants={itemVariants}
              className="flex flex-nowrap gap-1.5 sm:flex-wrap sm:gap-4 mb-8 sm:mb-12 justify-center lg:justify-start"
            >
              <Button
                size="sm"
              ...
              <Button
                size="sm"
                variant="outline"
                className="hover-elevate gap-1 text-[10px] px-2.5 py-1 h-7 sm:h-9 sm:text-sm sm:px-4 sm:gap-2"
                asChild
              ...
              <Button
                size="sm"
                variant="ghost"
                className="hover-elevate gap-1.5 sm:gap-2 hidden sm:inline-flex"
                asChild
