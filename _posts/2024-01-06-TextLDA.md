...
Similar analysis holds for the Interventions Description section. In this case, we look at what methods the researchers used to develop an Intervention. The Intervention description details can be found in the study protocol, but going through several of them can prove time-consuming. Employing topic models gives us an edge in doing an overview of what might be the recurring theme.
